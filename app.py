...
# CSS Avançado para criar os Cards automaticamente em containers
st.markdown(f"""
    <style>
        ...
        /* ESTILO DOS CARDS (Aplicado aos containers) */
...
def carregar_dados():
    try:
        ...
        # Mapeamento para nomes completos conforme solicitado
...
if not df_base.empty:
    ...
    with aba1:
        ...
        if not df_filtrado.empty:
            ...
            with col_esq:
                with st.container(border=True): # O card é criado aqui
    ...
    with aba2:
        ...
        with st.container(border=True): # RESOLVE O PROBLEMA DO TÍTULO FORA DO CARD
