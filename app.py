...
COR_PRIMARIA = "#10b981"   
COR_SECUNDARIA = "#1e293b" # Azul Marinho para textos fortes
...
# CSS Reforçado para forçar cores de texto
st.markdown(f"""
    <style>
        @import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap');
        
        /* Forçando a cor global para garantir que nada fique branco sem querer */
        html, body, [class*="css"] {{ 
        ...
        .chart-container {{ 
            ...
            margin-bottom: 24px;
            color: {COR_SECUNDARIA} !important; /* Garante texto escuro dentro do card */
        }}
...
if not df_base.empty:
    ...
    with aba1:
        ...
        if not df_filtrado.empty:
            ...
            with col_esq:
                # CORREÇÃO DE COR DO TÍTULO AQUI
            ...
            with col_dir:
                # CORREÇÃO DE COR E NOME DO TÍTULO AQUI
            ...
            # CORREÇÃO DE COR DO TÍTULO DA TABELA
