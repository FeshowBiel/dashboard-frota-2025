...
# CSS Reforçado para forçar visibilidade dos rótulos (labels)
st.markdown(f"""
    <style>
        ...
        /* CORREÇÃO DO LABEL (Título do Selectbox e outros campos) */
        ...
        /* Estilo para garantir que containers com border=True pareçam Cards Premium */
...
# --- 3. SIDEBAR ---
with st.sidebar:
    st.markdown(f"### <span style='color:{COR_SECUNDARIA}'>⚙️ Parâmetros</span>", unsafe_allow_html=True)
...
if not df_base.empty:
    ...
    with aba2:
        ...
        # O título "Auditar Período" agora estará visível em azul marinho
